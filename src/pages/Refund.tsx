...
const refundSchema = z.object({
    ...
    category: z.string().min(1, { message: "Inform a categoria" }),
    amount: z.coerce.number({ message: "Informe um valor válido" }).positive({ message: "Informe um valor valido e superior a 0" })
})
    ...
    return (
        <form onSubmit={onSubmit} className="bg-gray-500 w-full rounded-xl flex flex-col p-10 gap-6 lg:min-w-[512px]">
            <header>
                ...
                <p className="text-sm text-gray-200 mt-2 mb-4">Dados da empresa para solicitar reembolso.</p>
            </header>
            ...
            {params.id ? (
                <a
                    href="https://github.com/MarcosHHOshiro"
                    target="_blanck"
